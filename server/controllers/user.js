    ...
    if (email_verified) {
      ...
      if (user) {
        ...
        const FirstProject = new Project({
          title: "Начальный проект",
          description:
            "Это ваш первый проект, где вы можете создать доски и задачи, чтобы управлять вашим проектом",
          userId: user._id,
        });
        ...
        const FirstBoard = new Board({
          title: "Начальная доска",
          description:
            "Это ваша начальная доска, где вы можете создать задачи",
        ...
        const defaultColumns = ["В планах", "В прогрессе", "Завершено"];
